    ...
    <Container>
        ...
        <form>
            <div>
                ...
                <input name="username" type="text" placeholder='username' onChange={handleChange} value={userInfo.username}/>
            </div>
            <div>
                <label>Email</label>
            ...
            <div>
                ...
                <input name="confirmPassword" type="password" placeholder='*******' onChange={handleChange} value={userInfo.confirmPassword}/>
            </div>
